...
const T = {
  de: {
    ...
    intro: 'Du bist Interim Manager oder Berater mit eigenem Netzwerk und willst mehr, als nur Mandate abzuarbeiten? Dann bau mit uns aus. Als assoziierter Partner der Phalanx GmbH verdienst du an dem mit, was du einbringst: Kontakte, Projekte, Umsetzungskraft.',
    karten: [
      { icon: Users, titel: 'Recruiting', text: 'Du kennst gute Leute. Empfiehl Experten für unser Netzwerk. Kommt über deine Empfehlung ein Mandat zustande, bist du am Erfolg beteiligt.' },
      { icon: Search, titel: 'Projektakquise', text: 'Du hörst von einem Projekt, das gerade nicht zu dir passt? Bring es ein. Wir übernehmen Besetzung und Abwicklung, du erhältst eine Vermittlungsbeteiligung.' },
      { icon: HeartHandshake, titel: 'Delivery', text: 'Große Mandate stemmt niemand allein. Als Partner arbeitest du in Phalanx-Projekten mit, vom Teilprojekt bis zur gemeinsamen Projektleitung.' },
    ],
    verguetung: 'Die Konditionen legen wir gemeinsam fest, offen und pro Fall. Kein Kleingedrucktes.',
    formTitel: 'Interesse? Schreib uns.',
    vorname: 'Vorname', nachname: 'Nachname', email: 'E-Mail', telefon: 'Telefon (optional)',
    interesse: 'Was interessiert dich?',
    fokusLabels: { recruiting: 'Recruiting', akquise: 'Projektakquise', delivery: 'Delivery' },
    nachricht: 'Deine Nachricht (optional)',
